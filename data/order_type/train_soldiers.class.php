  ...
  class Train_Soldiers extends Player_Order {
    public function execute() {
      ...
      if( isset( $parameters['count'] ) ) {
        ...
        $player->set_player_resource_history( $game_id, 5, $resource_turn, mktime(), - $budget_spent, $message, $this->get_id() );
        $player->set_player_resource_history( $game_id, 2, $resource_turn, mktime(), $soldiers_trained, $message, $this->get_id() );
