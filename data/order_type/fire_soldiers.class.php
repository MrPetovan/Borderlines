  ...
  class Fire_Soldiers extends Player_Order {
    public function execute() {
      ...
      if( isset( $parameters['count'] ) ) {
        ...
        $player->set_player_resource_history( $game_id, 2, $resource_turn, mktime(), - $soldiers_fired, $message, $this->get_id() );
        $player->set_player_resource_history( $game_id, 5, $resource_turn, mktime(), $budget_gained, $message, $this->get_id() );
