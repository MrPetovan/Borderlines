...
) ENGINE=InnoDB AUTO_INCREMENT=5031 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2109 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2909 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `territory_owner` (
  ...
  CONSTRAINT `territory_owner_ibfk_4` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`),
  CONSTRAINT `territory_owner_ibfk_5` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_owner_ibfk_6` FOREIGN KEY (`owner_id`) REFERENCES `player` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `world` (
  ...
  `generation_method` enum('territory_generation_simple') NOT NULL DEFAULT 'territory_generation_simple',
...
-- Dump completed on 2012-10-21  1:09:19
