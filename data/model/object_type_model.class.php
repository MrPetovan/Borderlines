...
class Object_Type_Model extends DBObject {
  // Champs BD
  protected $_name = null;
  protected $_flag_magic = null;
  ...
  /* ACCESSEURS */
  public static function get_table_name() { return "object_type"; }

  public function get_flag_magic() { return $this->is_flag_magic(); }
  public function is_flag_magic() { return ($this->_flag_magic == 1); }

  /* MUTATEURS */
  public function set_id($id) {
    if( is_numeric($id) && (int)$id == $id) $data = intval($id); else $data = null; $this->_id = $data;
  }
  public function set_flag_magic($flag_magic) {
    if($flag_magic) $data = 1; else $data = 0; $this->_flag_magic = $data;
  }
  ...
  public static function db_get_select_list() {
    ...
    $object_list = Object_Type_Model::db_get_all();
  ...
  public function html_get_form($form_url) {
    ...
    <fieldset>
      <legend>Text fields</legend>
        ...
        <p class="field">'.HTMLHelper::genererInputCheckBox('flag_magic', '1', $this->get_flag_magic(), array('label_position' => 'right'), "Flag Magic" ).'</p>
    </fieldset>';
