...
WHERE `game_id` = '.mysql_ureal_escape_string($this->get_id()).$where;
  ...
  public function set_territory_owner( $territory_id, $turn, $owner_id, $contested ) {
    $sql = "REPLACE INTO `territory_owner` ( `territory_id`, `game_id`, `turn`, `owner_id`, `contested` ) VALUES (".mysql_ureal_escape_string( $territory_id, $this->get_id(), $turn, $owner_id, $contested ).")";
