...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan="4"><?php echo $game->max_players?__('%s/%s players', count( $game_player_list ), $game->max_players):__('%s players', count( $game_player_list ))?></td>
    </tr>
  </tfoot>
  <tbody>
<?php
