...
) ENGINE=InnoDB AUTO_INCREMENT=4875 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_diplomacy` (
  ...
  CONSTRAINT `player_diplomacy_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`),
  CONSTRAINT `player_diplomacy_ibfk_2` FOREIGN KEY (`from_player_id`) REFERENCES `player` (`id`),
  CONSTRAINT `player_diplomacy_ibfk_3` FOREIGN KEY (`to_player_id`) REFERENCES `player` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `territory_player_spies`
--

DROP TABLE IF EXISTS `territory_player_spies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `territory_player_spies` (
  `game_id` int(11) NOT NULL,
  `turn` int(11) NOT NULL,
  `territory_id` int(11) NOT NULL,
  `player_id` int(11) NOT NULL,
  ...
  CONSTRAINT `territory_player_spies_ibfk_3` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_player_spies_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_player_spies_ibfk_2` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-10-20 15:10:53
