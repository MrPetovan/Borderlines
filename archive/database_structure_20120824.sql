...
CREATE TABLE `game` (
  ...
  CONSTRAINT `game_ibfk_2` FOREIGN KEY (`world_id`) REFERENCES `world` (`id`),
  CONSTRAINT `game_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `player` (`id`)
...
-- Dump completed on 2012-08-24 18:24:14
