...
) ENGINE=InnoDB AUTO_INCREMENT=5481 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2339 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6383 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `territory_player_troops` (
  ...
  CONSTRAINT `territory_player_troops_ibfk_4` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_player_troops_ibfk_5` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_player_troops_ibfk_6` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `translation` (
  ...
  `locale` varchar(10) CHARACTER SET latin1 NOT NULL,
  `translation` text CHARACTER SET latin1,
...
-- Dump completed on 2012-11-04 18:35:49
