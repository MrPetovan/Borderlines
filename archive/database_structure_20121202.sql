...
) ENGINE=InnoDB AUTO_INCREMENT=474 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_order` (
  ...
  CONSTRAINT `player_order_ibfk_9` FOREIGN KEY (`parent_player_order_id`) REFERENCES `player_order` (`id`) ON DELETE CASCADE,
  CONSTRAINT `player_order_ibfk_6` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=6165 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=17683 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `territory_owner` (
  ...
  CONSTRAINT `territory_owner_ibfk_7` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_owner_ibfk_8` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_owner_ibfk_9` FOREIGN KEY (`owner_id`) REFERENCES `player` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-12-02 21:10:54
