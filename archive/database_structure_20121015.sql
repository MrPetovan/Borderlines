...
CREATE TABLE `game` (
  ...
  CONSTRAINT `game_ibfk_1` FOREIGN KEY (`world_id`) REFERENCES `world` (`id`) ON DELETE NO ACTION,
  CONSTRAINT `game_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `player` (`id`) ON DELETE NO ACTION
...
CREATE TABLE `game_player` (
  ...
  KEY `player_id` (`player_id`),
  CONSTRAINT `game_player_ibfk_4` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=244 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5088 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-10-15 23:57:42
