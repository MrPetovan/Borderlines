...
CREATE TABLE `game` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(256) NOT NULL,
  `version` enum('text','world','economy','spies','population') NOT NULL DEFAULT 'economy',
  ...
  CONSTRAINT `game_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `player` (`id`) ON DELETE NO ACTION
...
CREATE TABLE `game_player` (
  ...
  CONSTRAINT `game_player_ibfk_3` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `member` (
  ...
  `pays` char(2) COLLATE utf8_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5186 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_diplomacy` (
  ...
  `status` enum('Enemy','Neutral','Ally') NOT NULL,
  `shared_vision` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`game_id`,`turn`,`from_player_id`,`to_player_id`),
  KEY `from_player_id` (`from_player_id`),
  KEY `to_player_id` (`to_player_id`),
  CONSTRAINT `player_diplomacy_ibfk_4` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
  CONSTRAINT `player_diplomacy_ibfk_5` FOREIGN KEY (`from_player_id`) REFERENCES `player` (`id`) ON DELETE CASCADE,
  CONSTRAINT `player_diplomacy_ibfk_6` FOREIGN KEY (`to_player_id`) REFERENCES `player` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_history` (
  ...
  CONSTRAINT `player_history_ibfk_10` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
  CONSTRAINT `player_history_ibfk_11` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`) ON DELETE CASCADE,
  CONSTRAINT `player_history_ibfk_12` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_order` (
  ...
  `parent_player_order_id` int(11) DEFAULT NULL,
  UNIQUE KEY `id` (`id`),
  KEY `game_id` (`game_id`),
  KEY `order_type_id` (`order_type_id`),
  KEY `player_id` (`player_id`),
  KEY `parent_player_order_id` (`parent_player_order_id`),
  CONSTRAINT `player_order_ibfk_10` FOREIGN KEY (`order_type_id`) REFERENCES `order_type` (`id`),
  CONSTRAINT `player_order_ibfk_11` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`),
  CONSTRAINT `player_order_ibfk_12` FOREIGN KEY (`parent_player_order_id`) REFERENCES `player_order` (`id`) ON DELETE CASCADE,
  CONSTRAINT `player_order_ibfk_7` FOREIGN KEY (`order_type_id`) REFERENCES `order_type` (`id`),
  CONSTRAINT `player_order_ibfk_8` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`),
  CONSTRAINT `player_order_ibfk_9` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6825 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shout` (
  ...
  CONSTRAINT `shout_ibfk_4` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=17916 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `territory_economy_history`
--

DROP TABLE IF EXISTS `territory_economy_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `territory_economy_history` (
  `territory_id` int(11) NOT NULL,
  `game_id` int(11) NOT NULL,
  `turn` int(11) NOT NULL,
  `delta` decimal(3,2) NOT NULL DEFAULT '0.00',
  `reason` varchar(255) NOT NULL,
  KEY `territory_id` (`territory_id`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `territory_economy_history_ibfk_1` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`),
  CONSTRAINT `territory_economy_history_ibfk_2` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `territory_neighbour` (
  ...
  `guid1` varchar(10) NOT NULL,
  `guid2` varchar(10) NOT NULL,
...
--
-- Table structure for table `territory_player_status`
--

DROP TABLE IF EXISTS `territory_player_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `territory_player_status` (
  `game_id` int(11) NOT NULL,
  `turn` int(11) NOT NULL,
  `territory_id` int(11) NOT NULL,
  `player_id` int(11) NOT NULL,
  `supremacy` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`game_id`,`turn`,`territory_id`,`player_id`),
  KEY `player_id` (`player_id`),
  KEY `territory_id` (`territory_id`),
  CONSTRAINT `territory_player_status_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_player_status_ibfk_2` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_player_status_ibfk_3` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `territory_player_troops_history`
--

DROP TABLE IF EXISTS `territory_player_troops_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `territory_player_troops_history` (
  `game_id` int(11) NOT NULL,
  `turn` int(11) NOT NULL,
  `territory_id` int(11) NOT NULL,
  `player_id` int(11) NOT NULL,
  ...
  `reason_player_id` int(11) DEFAULT NULL,
  KEY `player_id` (`player_id`),
  KEY `territory_id` (`territory_id`),
  KEY `game_id` (`game_id`),
  KEY `reason_player_id` (`reason_player_id`),
  KEY `turn` (`turn`),
  CONSTRAINT `territory_player_troops_history_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`),
  CONSTRAINT `territory_player_troops_history_ibfk_2` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`),
  CONSTRAINT `territory_player_troops_history_ibfk_3` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`),
  CONSTRAINT `territory_player_troops_history_ibfk_4` FOREIGN KEY (`reason_player_id`) REFERENCES `player` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `territory_status`
--

DROP TABLE IF EXISTS `territory_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `territory_status` (
  ...
  `revenue_suppression` decimal(3,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`territory_id`,`game_id`,`turn`),
  KEY `game_id` (`game_id`),
  KEY `owner_id` (`owner_id`),
  CONSTRAINT `territory_status_ibfk_7` FOREIGN KEY (`territory_id`) REFERENCES `territory` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_status_ibfk_8` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON DELETE CASCADE,
  CONSTRAINT `territory_status_ibfk_9` FOREIGN KEY (`owner_id`) REFERENCES `player` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `world` (
  ...
  `generation_method` enum('simple','voronoi') NOT NULL DEFAULT 'simple',
  `generation_parameters` text,
  `created` datetime NOT NULL,
  `created_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `created_by` (`created_by`),
  CONSTRAINT `world_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `player` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2015-01-31  0:23:22
