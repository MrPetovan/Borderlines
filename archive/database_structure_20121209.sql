...
) ENGINE=InnoDB AUTO_INCREMENT=4928 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `territory_status` (
  ...
  `economy_ratio` decimal(3,2) NOT NULL DEFAULT '0.00',
...
-- Dump completed on 2012-12-09 12:56:16
